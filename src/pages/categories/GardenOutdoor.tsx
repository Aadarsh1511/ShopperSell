...
const GardenOutdoor = () => {
  ...
  const products = [
    {
      id: 1,
      title: "Ceramic Plant Pot Set - 3 Sizes",
      price: "$49.99",
      originalPrice: "$65.99",
      rating: 4.8,
      reviews: 187,
    ...
    {
      id: 2,
      title: "Solar Garden Light String - 50ft",
      price: "$29.99",
      originalPrice: null,
      rating: 4.6,
      reviews: 234,
    ...
    {
      id: 3,
      title: "Weather-Resistant Outdoor Cushions",
      price: "$79.99",
      originalPrice: "$99.99",
      rating: 4.7,
      reviews: 145,
      image: "/src/assets/category-home-kitchen.jpg",
      seller: "OutdoorComfort",
      isLiked: false
    },
    {
      id: 4,
      title: "Hanging Garden Basket - Macrame",
      price: "$24.99",
      originalPrice: null,
      rating: 4.9,
      reviews: 298,
      ...
      <main>
        <section className="py-12 px-6 bg-gradient-to-r from-slate-100 to-gray-100 dark:from-slate-900/20 dark:to-gray-900/20">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl font-bold text-foreground mb-4">Garden & Outdoor</h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Create your perfect outdoor oasis with our garden and outdoor essentials
            </p>
          </div>
        </section>
