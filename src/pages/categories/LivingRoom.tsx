...
const LivingRoom = () => {
  const products = [
    ...
    {
      id: 2,
      title: "Glass Coffee Table with Storage",
      price: "$299.99",
      originalPrice: null,
      rating: 4.6,
      reviews: 156,
    ...
    {
      id: 3,
      title: "Velvet Accent Chair - Navy Blue",
      price: "$449.99",
    ...
    {
      id: 4,
      title: "Wooden TV Stand - Oak Finish",
      price: "$199.99",
      originalPrice: null,
      rating: 4.7,
      reviews: 312,
    ...
    {
      id: 5,
      title: "Floor Lamp with Reading Light",
      price: "$129.99",
      ...
      <main>
        ...
        <section className="py-12 px-6 bg-gradient-to-r from-primary/10 to-secondary/10">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl font-bold text-foreground mb-4">Living Room Essentials</h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Create your perfect living space with our curated collection of sofas, chairs, tables, and décor
            </p>
          </div>
        </section>
