...
const PlusSize = () => {
  ...
  const products = [
    {
      id: 1,
      title: "Elegant Plus Size Maxi Dress",
      price: "$79.99",
      originalPrice: "$99.99",
      rating: 4.8,
      reviews: 234,
    ...
    {
      id: 2,
      title: "Comfortable Stretch Jeans - Plus",
      price: "$59.99",
      originalPrice: null,
      rating: 4.7,
      reviews: 167,
    ...
    {
      id: 3,
      title: "Flowy Chiffon Blouse - Curves",
      price: "$49.99",
      originalPrice: "$65.99",
      rating: 4.9,
      reviews: 289,
    ...
    {
      id: 4,
      title: "Plus Size Activewear Set",
      price: "$89.99",
      originalPrice: null,
      rating: 4.6,
      reviews: 198,
      ...
      <main>
        <section className="py-12 px-6 bg-gradient-to-r from-slate-100 to-gray-100 dark:from-slate-900/20 dark:to-gray-900/20">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl font-bold text-foreground mb-4">Plus Size Fashion</h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Beautiful clothing for every body - stylish and comfortable plus size fashion
            </p>
          </div>
        </section>
