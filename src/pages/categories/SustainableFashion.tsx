...
const SustainableFashion = () => {
  ...
  const products = [
    ...
    {
      id: 3,
      title: "Hemp Blend Casual Pants",
      price: "$89.99",
      originalPrice: "$110.00",
      rating: 4.9,
      reviews: 89,
      image: "/src/assets/category-fashion.jpg",
      seller: "NaturalFibers",
      isLiked: false
    },
    {
      id: 4,
      title: "Bamboo Fiber Activewear Set",
      price: "$119.99",
      originalPrice: null,
      rating: 4.6,
      reviews: 145,
      ...
      <main>
        <section className="py-12 px-6 bg-gradient-to-r from-slate-100 to-gray-100 dark:from-slate-900/20 dark:to-gray-900/20">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl font-bold text-foreground mb-4">Sustainable Fashion</h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Fashion that cares for the planet - eco-friendly and ethically made clothing
            </p>
          </div>
        </section>
