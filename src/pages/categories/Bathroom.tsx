...
const Bathroom = () => {
  ...
  const products = [
    ...
    {
      id: 3,
      title: "Rainfall Shower Head - Chrome",
      price: "$89.99",
      ...
      <main>
        <section className="py-12 px-6 bg-gradient-to-r from-slate-100 to-gray-100 dark:from-slate-900/20 dark:to-gray-900/20">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl font-bold text-foreground mb-4">Bathroom Essentials</h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Transform your bathroom into a spa-like retreat with our premium collection
            </p>
          </div>
        </section>
