...
const StorageOrganization = () => {
  ...
  const products = [
    {
      id: 1,
      title: "Multi-Tier Storage Rack - Bamboo",
      price: "$89.99",
    ...
    {
      id: 2,
      title: "Fabric Storage Bins - Set of 6",
      price: "$39.99",
      originalPrice: null,
      rating: 4.7,
      reviews: 167,
    ...
    {
      id: 3,
      title: "Under-Bed Storage Boxes - Clear",
      price: "$45.99",
      originalPrice: "$60.99",
      rating: 4.6,
      reviews: 289,
    ...
    {
      id: 4,
      title: "Wall-Mounted Shelf Organizer",
      price: "$65.99",
      originalPrice: null,
      rating: 4.9,
      reviews: 198,
      ...
      <main>
        <section className="py-12 px-6 bg-gradient-to-r from-slate-100 to-gray-100 dark:from-slate-900/20 dark:to-gray-900/20">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl font-bold text-foreground mb-4">Storage & Organization</h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Keep your space tidy and organized with our smart storage solutions
            </p>
          </div>
        </section>
