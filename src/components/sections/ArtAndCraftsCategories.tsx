...
const ArtAndCraftsCategories = () => {
  const navigate = useNavigate();

  const categories = [
    {
      title: "Paintings & Prints",
      description: "Original artworks, prints & illustrations",
      image: "/src/assets/category-arts-crafts.jpg",
      itemCount: "3,450+ items",
      slug: "paintings-prints"
    },
    {
      title: "Handmade Crafts",
      description: "Pottery, woodwork & handcrafted items",
    ...
    },
    {
      ...
      description: "Materials, tools & kits for creators",
      image: "/src/assets/category-arts-crafts.jpg",
    ...
    },
    {
      ...
      description: "Unique sculptures & dimensional art",
      image: "/src/assets/product-mug.jpg",
      itemCount: "980+ items",
    ...
    {
      title: "Digital Art",
      description: "Digital prints & modern art",
      image: "/src/assets/category-arts-crafts.jpg",
    ...
    {
      title: "DIY Kits",
      description: "Complete kits for creative projects",
      image: "/src/assets/product-mug.jpg",
    ...
    <section className="py-16 px-6">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-foreground mb-4">Art & Craft Categories</h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Explore diverse artistic expressions and creative supplies
          </p>
        </div>
...
export default ArtAndCraftsCategories;