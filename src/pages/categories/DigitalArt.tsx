...
const DigitalArt = () => {
  ...
  const products = [
    {
      id: 1,
      title: "Digital Abstract Print - NFT Style",
      price: "$29.99",
      originalPrice: "$39.99",
      rating: 4.8,
      reviews: 156,
    ...
    {
      id: 2,
      title: "Cyberpunk Cityscape - Digital Print",
      price: "$24.99",
      originalPrice: null,
      rating: 4.9,
      reviews: 234,
    ...
    {
      id: 3,
      title: "Minimalist Geometric Art Print",
      price: "$19.99",
      originalPrice: "$25.99",
      rating: 4.7,
      reviews: 189,
      ...
      <main>
        <section className="py-12 px-6 bg-gradient-to-r from-slate-100 to-gray-100 dark:from-slate-900/20 dark:to-gray-900/20">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl font-bold text-foreground mb-4">Digital Art</h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Modern digital creations and prints for the contemporary art lover
            </p>
          </div>
        </section>
