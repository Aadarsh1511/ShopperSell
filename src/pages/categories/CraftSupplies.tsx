...
const CraftSupplies = () => {
  ...
  const products = [
    ...
    {
      id: 2,
      title: "Premium Watercolor Paper Pack",
      price: "$29.99",
      originalPrice: null,
      rating: 4.9,
      reviews: 167,
    ...
    {
      id: 3,
      title: "Artist Brush Set - 15 Pieces",
      price: "$34.99",
      originalPrice: "$45.99",
      rating: 4.7,
      reviews: 289,
    ...
    {
      id: 4,
      title: "Embroidery Floss Bundle - 50 Colors",
      price: "$24.99",
      originalPrice: null,
      rating: 4.6,
      reviews: 198,
      ...
      <main>
        <section className="py-12 px-6 bg-gradient-to-r from-slate-100 to-gray-100 dark:from-slate-900/20 dark:to-gray-900/20">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl font-bold text-foreground mb-4">Craft Supplies</h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Everything you need for your creative projects - premium materials and tools
            </p>
          </div>
        </section>
