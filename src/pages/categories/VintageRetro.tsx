...
const VintageRetro = () => {
  ...
  const products = [
    {
      id: 1,
      title: "Vintage 70s Floral Dress",
      price: "$129.99",
    ...
    {
      id: 2,
      title: "Retro Denim Jacket - 80s Style",
      price: "$89.99",
      originalPrice: null,
      rating: 4.7,
      reviews: 234,
    ...
    {
      id: 3,
      title: "Classic Band T-Shirt Collection",
      price: "$45.99",
      originalPrice: "$55.99",
      rating: 4.8,
      reviews: 145,
      ...
      <main>
        <section className="py-12 px-6 bg-gradient-to-r from-slate-100 to-gray-100 dark:from-slate-900/20 dark:to-gray-900/20">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl font-bold text-foreground mb-4">Vintage & Retro Fashion</h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Step back in time with our curated vintage pieces and retro-inspired designs
            </p>
          </div>
        </section>
