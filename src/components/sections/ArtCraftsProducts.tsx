...
import categoryArtImage from '@/assets/category-arts-crafts.jpg';
import productMugImage from '@/assets/product-mug.jpg';

const ArtCraftsProducts = () => {
  ...
  const products = [
    {
      id: 1,
      title: "Hand-Painted Canvas Art Set",
      price: 145.99,
      originalPrice: 165.99,
      rating: 4.9,
      reviews: 87,
      image: categoryArtImage,
      isLiked: false,
      shop: "Canvas Dreams"
    },
    {
      id: 2,
      title: "Ceramic Pottery Workshop Kit",
      price: 89.50,
      rating: 4.8,
      reviews: 134,
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Express your creativity with premium art supplies and craft materials
          </p>
        </div>
...
export default ArtCraftsProducts;